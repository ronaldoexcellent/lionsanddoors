// Code JS Version 1.8.78
// Start
console.log('Loading Code JS Framework/Library... Version 1.8.78');
console.log('Finished Loading...');
console.time("Load Time");                                      

// Framework/Library Data
const CodeJS = {
    version : "Code JS Version 1.8.78",
...
const app = {
    ...
    copyright : d.year(),
    projectStart : application.getAttribute('projectstart'),
    projectEnd : application.getAttribute('projectend'),
    backgroundData : () => {
        // Conection Test
...
function _start() {
    ...
    function LOADFULLPACKAGE() {
        ...
        const $app_extras = () => {
            app_Head.innerHTML = "<title></title> <meta name='application-name' content='" + app.name + "' />" + app_Head.innerHTML; app_Head.innerHTML += `<meta name="author" content=${app.author} /> <meta name="color-scheme" content=""> <meta name="copyright" content="` + app.copyright + '" />  <link rel="icon" type="image/x-icon" href="' + application.getAttribute('logo') + '" /> <style id="style-root"> @import url("css/root.css"); </style>';
